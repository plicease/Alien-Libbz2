...
sub cflags
{
  ...
  return $cflags if ! wantarray;  ## no critic(Community::Wantarray)
...
sub libs
{
  ...
  return $libs if ! wantarray;  ## no critic(Community::Wantarray)
  require Text::ParseWords;
...
sub dlls
{
  ...
  wantarray ? @dlls : $dlls[0]; ## no critic(Community::Wantarray)
}
